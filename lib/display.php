...
<table width="90%">
<tr>
	<td class="naglowek" align="center">Dodaj użytkowników<hr></td>
</tr>
<form action="<?=get_www_root()?>admin/add_users.php" method="POST">
<tr>
	<td><table><tr>
		<td align="right" valign="top">Wymień loginy nowych użytkowników:<br>
...
<table width="90%">
<tr>
	<td align="center" class="naglowek">Zaraz dodasz użytkowników<hr></td>
</tr>
<tr>
	<td>
	<table>
...
?>
	<tr>
		<td align="right" valign="top"><b>Istniejący użytkownicy (zostaną zignorowani):</b></td>
		<td align="left">
<?php
...
?>
	...
	<tr>
		<td align="right" valign="top"><b>Nowi użytkownicy:</b></td>
		<td align="left">
<?php
